...
function registerDelegate(tree){
	...
	$("#"+tree).delegate("li ins","click", function(e) {
		...
		if (classState == false){
			...
			var cacheData = hashMap.get(currentNodeId);
			if (cacheData != null){
			...
			console.log("before swuitch");
				switch(currentCategoryLevel){
					...
					case "2": 	dataObj3 =getObject(jsonData,currentNodeId,currentCategoryLevel,x.parentNode.parentNode.id);
								...
								hashMap.put(currentNodeId,currentTreeArray);
								console.log("case2");
								
								//leafClass = 'jstree-leaf';
							break;
							
					case "3": 	dataObj4 = hashMap.get(x.parentNode.parentNode.id);
								...
								console.log("case3");
							break;
					case "4": 	dataObj5 = hashMap.get(x.parentNode.parentNode.id);
								...
								console.log("case4");
							break;
					case "5": 	dataObj6 = hashMap.get(x.parentNode.parentNode.id);
								currentTreeArray =getObject(dataObj6,currentNodeId,currentCategoryLevel);
								currentIndex = currentTreeArray.index;
								currentTreeArray = currentTreeArray.jsonData;
								hashMap.put(currentNodeId,currentTreeArray);
							break;
					case "6": 	dataObj7 = hashMap.get(x.parentNode.parentNode.id);
								currentTreeArray =getObject(dataObj7,currentNodeId,currentCategoryLevel);
								currentIndex = currentTreeArray.index;
								currentTreeArray = currentTreeArray.jsonData;
								hashMap.put(currentNodeId,currentTreeArray);
							break;
					case "7": 	dataObj8 =hashMap.get(x.parentNode.parentNode.id);
							...
							break;	
					case "8": 	dataObj9 =hashMap.get(x.parentNode.parentNode.id);
